...
- (void)loadData
{
    ...
    [[Service sharedInstance]fetchFlickrInterestingPhotosWithCompletion:^(NSArray *response, NSError *error) {
        ...
        if(!error){
            ...
            _dataModels = [NSArray arrayWithArray: response];
...
//        NSFetchRequest* request = [coreDataM.managedObjectModel fetchRequestFromTemplateWithName:@"getUserById"
//                                                                                substitutionVariables:@{@"USER_ID" : idNum}];
//        NSError* error = nil;
//        NSArray* results = [coreDataHelper.managedObjectContext executeFetchRequest:request error:&error];
//        User *user;
//        if ([results count]) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.data = _dataModels[indexPath.row];
    return cell;
}
...
//        PhotoModel *model = (PhotoModel*)[_fetchedResultsController objectAtIndexPath:indexPath];
        PhotoModel *model = _dataModels[indexPath.row];
